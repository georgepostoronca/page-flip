...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/page-flip/dist/js/page-flip.browser.js":[function(require,module,exports) {
var define;
...
function flipbookStatus(root) {
  var status = 0;
  var images = [].slice.call(root.querySelectorAll("img"));
  var imagesLoaded = 0;
